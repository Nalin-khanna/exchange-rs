...
#[get("/get_orderbook")]
pub async fn get_orderbook(data : web::Data<AppState> , payload : web::Json<GetOrderbookPayload> , username : AuthenticatedUser) -> impl Responder {
    let (tx ,  rx) = oneshot::channel::<Result<Orderbooks,String>>();
